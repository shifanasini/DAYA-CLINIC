...
ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://" + ip + ":8000/myapp/view_tips_patient/";
...
//                                li.setAdapter(ad);
                                li.setAdapter(new custom_tip(getApplicationContext(),id,tips));
