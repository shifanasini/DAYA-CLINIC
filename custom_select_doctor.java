...
public class custom_select_doctor  extends BaseAdapter {
    ...
    public custom_select_doctor(android.content.Context applicationContext, String[] id, String[]doc_name,String[]photo) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.cust_select_doctor, null);
